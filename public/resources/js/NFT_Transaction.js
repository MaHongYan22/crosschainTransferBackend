    ...
    $.ajax({
        ...
        success: function(value) {
            ...
            for (var i = 0; i < arr.length; i++) {
                $("tbody").append("<tr>" +
                    "<td><input type='checkbox' class='item' index='" + arr[i].transaction_id + "'></td>" +
                    "<td>" + arr[i].transaction_id + "</td>" +
                    "<td>" + arr[i].status + "</td>" +
                    "<td>" + arr[i].senderAddress + "</td>" +
                    // "<td>" + arr[i].recipient_chain_id + "</td>" + 
                    "<td>" + arr[i].token_id + "</td>" +
                    "<td>" + arr[i].NFT_Address + "</td>" +
                    "<td>" + arr[i].recipientAddress + "</td>" +
                    "<td>" + arr[i].create_time + "</td>" +
                    "<td><input type='button' value='修改' class='update' index='" + arr[i].transaction_id + "'><input type='button' value='删除' class='delete' index='" + arr[i].transaction_id + "'></td>" +
                    "</tr>")
            }
...
$(".reclaimNFT").on("click", function() {

    location.href = "reclaimNFT";
})
$(".approveNFT").on("click", function() {

    location.href = "NFTapprove";
})
$(".crosschainNFT").on("click", function() {

    location.href = "NFTcrosschain";
})
