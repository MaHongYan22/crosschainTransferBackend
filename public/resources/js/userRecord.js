    ...
    $.ajax({
        ...
        success: function(value) {
            ...
            for (var i = 0; i < arr.length; i++) {
                $("tbody").append("<tr>" +
                    "<td><input type='checkbox' class='item' index='" + arr[i].transaction_transactionId + "'></td>" +
                    ...
                    "<td><input type='button' value='修改' class='update' index='" + arr[i].transactionId + "'><input type='button' value='删除' class='delete' index='" + arr[i].transactionId + "'></td>" +
                    "</tr>")
            }
